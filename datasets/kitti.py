...
class KITTIDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        preprocessed_ground_truth_1 = self.preprocess_odometry_matrix(raw_odometry_matrix_1, current_dataset.poses[0][:3, :4])
        preprocessed_ground_truth_2 = self.preprocess_odometry_matrix(raw_odometry_matrix_2, current_dataset.poses[0][:3, :4])
    ...
    @staticmethod
    def preprocess_odometry_matrix(odometry_matrix: np.ndarray, initial_rotation_matrix) -> torch.Tensor:
        """
        ...
        # TODO: To be checked
        translation = initial_rotation_matrix[:3,:3].dot(translation)
